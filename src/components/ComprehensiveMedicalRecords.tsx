...
const studentRecords = [{
  ...
  previousVisits: [{
    ...
    date: "2024-04-15",
    reason: "Orientation health check",
  ...
  previousVisits: [{
    date: "2024-06-10",
    reason: "Adjustment counseling",
    doctor: "Dr. Mary Gyang"
  }, {
    date: "2024-04-25",
    reason: "Orientation health screening",
    doctor: "Dr. Aisha Mohammed"
  }]
}, {
  id: "STU008",
...
export const ComprehensiveMedicalRecords = () => {
  ...
  const RecordCard = ({
    record,
    isStaff = false
  }) => <Card key={record.id} className="hover-lift cursor-pointer transition-all duration-300" onClick={() => handleViewRecord(record)}>
      ...
      <CardContent>
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              {record.vitals && <div className="grid gap-3">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 mb-6">
              {record.medicalHistory?.map((entry, index) => <Card key={index} className="p-3">
            ...
            {record.previousVisits && <>
                ...
                <div className="space-y-2">
                  {record.previousVisits.map((visit, index) => <Card key={index} className="p-2">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3 mb-6">
              {record.prescriptions?.length > 0 ? record.prescriptions.map((prescription, index) => <Card key={index} className="p-3">
                  <div className="space-y-2">
                ...
                </Card>) : <p className="text-sm text-muted-foreground">No current medications</p>}
            </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              {record.vaccinations?.map((vaccination, index) => <Card key={index} className="p-3">
                  <div className="space-y-2">
                    <div className="flex justify-between items-start">
                      <h5 className="font-medium text-sm">{vaccination.vaccine}</h5>
                      <Badge className={new Date(vaccination.nextDue) > new Date() ? "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300" : "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300"}>
  ...
  return <div className="space-y-6">
      ...
      <Tabs defaultValue="staff" className="w-full">
        <TabsList className="grid w-full grid-cols-2 mb-4 h-8 p-0.5 bg-muted rounded-md">
          <TabsTrigger 
            value="staff" 
